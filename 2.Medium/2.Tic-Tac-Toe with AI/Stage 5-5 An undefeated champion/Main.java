        ...
        while (true) {
            ...
            if (command.length == 3) {
                if (command[0].equalsIgnoreCase("start")
                        && command[1].equalsIgnoreCase("user") || command[1].equalsIgnoreCase("easy") || command[1].equalsIgnoreCase("medium")||command[1].equalsIgnoreCase("hard")
                        && command[2].equalsIgnoreCase("user") || command[2].equalsIgnoreCase("easy") || command[2].equalsIgnoreCase("medium")||command[2].equalsIgnoreCase("hard")) {
                    break;
                }
        ...
        while (field.checkWinner()) {
            ...
            if (field.checkWinner()) {
                if (command[2].equalsIgnoreCase("user")) {
                    ...
                    field.medium(2);
                }else if (command[2].equalsIgnoreCase("hard")){
                    field.hard(2);
                }
            } else {
                break;
